...
import { detectCurrentAgent } from '../src/agent/detect'
...
describe('agent/detect', () => {
  ...
  describe('detectCurrentAgent', () => {
    it('detects claude-code from CLAUDE_CODE env', () => {
      ...
      expect(detectCurrentAgent()).toBe('claude-code')
    })
    ...
    it('detects cursor from CURSOR_SESSION env', () => {
      ...
      expect(detectCurrentAgent()).toBe('cursor')
    })
