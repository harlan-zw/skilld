...
export const PACKAGES: PackageSpec[] = [
  ...
  // Vue/Nuxt state management — git docs in packages/docs/ monorepo (prefix stripped to docs/).
  {
    ...
    expectDocsType: "docs",
    expectCacheFiles: ["docs/core-concepts/index.md"],
    minCacheDocs: 5,
  ...
  // Also has llms.txt at content.nuxt.com.
  {
    ...
    expectDocsType: "docs",
    expectCacheFiles: ["docs/content/docs/3.files/1.markdown.md"],
    minCacheDocs: 30,
  ...
  // React framework — git docs + llms.txt at nextjs.org.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: false },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/01-app/01-getting-started/01-installation.mdx"],
    minCacheDocs: 50,
  ...
  // Data fetching — git docs in monorepo docs/ folder.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/framework/react/overview.md"],
    minCacheDocs: 5,
  ...
  // Official router — git docs in packages/docs/ monorepo (prefix stripped to docs/).
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/guide/index.md"],
    minCacheDocs: 5,
  ...
  // Composition utilities — 300+ composable docs via monorepo (prefix stripped to docs/).
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: false, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/core/useActiveElement/index.md"],
    minCacheDocs: 100,
  ...
  // Falls back to README.
  {
    ...
    expectCacheFiles: ["docs/README.md"],
    minCacheDocs: 1,
  ...
  // Minimal state management — git docs in docs/ folder.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: false, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/guides/updating-state.md"],
    minCacheDocs: 3,
  ...
  // Form library — git docs has translated READMEs in docs/ folder.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: false, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["docs/Template.md"],
    minCacheDocs: 10,
  ...
  // Compiler framework — git docs + llms.txt at svelte.dev.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["documentation/docs/01-introduction/01-overview.md"],
    minCacheDocs: 10,
  ...
  // Content-focused framework — docs live in withastro/docs repo (override).
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["src/content/docs/en/basics/astro-components.mdx"],
    minCacheDocs: 100,
  ...
  // CSS framework — docs live in tailwindlabs/tailwindcss.com repo (override).
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: false, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["src/docs/accent-color.mdx"],
    minCacheDocs: 100,
  ...
  // Type-safe API layer — git docs in www/docs/.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["www/docs/server/routers.md"],
    minCacheDocs: 50,
  ...
  // Also has llms.txt at zod.dev. Git docs win because checked first.
  {
    ...
    expectSources: { npm: true, gitDocs: true, llmsTxt: true, readme: true },
    expectDocsType: "docs",
    expectCacheFiles: ["packages/docs/content/basics.mdx", "packages/docs/content/api.mdx"],
    minCacheDocs: 10,
