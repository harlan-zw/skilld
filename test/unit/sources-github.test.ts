...
} = await import("../../src/sources/github");
...
describe("sources/github", () => {
  ...
  describe("fetchGitHubRepoMeta", () => {
    it("returns homepage when available", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("https://api.github.com/repos/vuejs/vue", undefined);
    });
        ...
        json: () =>
          Promise.resolve({
            ...
            files: [
              ...
              {
                path: "apps/my-docs/src/content/docs/index.mdx",
                mode: "100644",
                sha: "b",
                size: 200,
              },
              {
                path: "apps/my-docs/src/content/docs/guides/setup.md",
                mode: "100644",
                sha: "c",
                size: 300,
              },
              {
                path: "apps/my-docs/src/content/docs/guides/config.mdx",
                mode: "100644",
                sha: "d",
                size: 250,
              },
  ...
  describe("fetchReadmeContent", () => {
    ...
    it("fetches regular URLs via fetchText", async () => {
      ...
      const result = await fetchReadmeContent(
  ...
  describe("validateGitDocsWithLlms", () => {
    ...
    it("handles absolute URL links by stripping to pathname", () => {
      ...
      const repoFiles = ["website/docs/guide/intro.md", "website/docs/api/core.md"];
