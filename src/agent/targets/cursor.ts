...
export const cursor = defineTarget({
  ...
  additionalSkillsDirs: [".claude/skills", ".codex/skills", "~/.claude/skills", "~/.codex/skills"],
  ...
  discoveryNotes:
    "Reads name + description at conversation start. Full SKILL.md body loads only when agent determines relevance. Users can also invoke via /skill-name.",
