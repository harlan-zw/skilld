...
export const geminiCli = defineTarget({
  ...
  discoveryNotes:
    "Scans at session start, injects ~100 tokens per skill (name+description). Activation via activate_skill tool requires user confirmation. Skill stays active for session duration.",
