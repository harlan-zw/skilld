...
export const amp = defineTarget({
  ...
  additionalSkillsDirs: [".claude/skills", "~/.config/amp/skills", "~/.claude/skills"],
  ...
  discoveryNotes:
    "Names + descriptions visible at startup. Full SKILL.md body loads only when agent decides to invoke based on description match.",
