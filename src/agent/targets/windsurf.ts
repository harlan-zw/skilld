...
export const windsurf = defineTarget({
  ...
  detectProject: (cwd) =>
    existsSync(join(cwd, ".windsurf")) || existsSync(join(cwd, ".windsurfrules")),
  ...
  discoveryNotes:
    "Cascade matches description against user requests for auto-invocation. Manual invocation via @skill-name.",
