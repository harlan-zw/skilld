...
export const claudeCode = defineTarget({
  ...
  frontmatter: [
    {
      ...
      required: false,
      description:
        "Skill identifier, becomes /slash-command. Defaults to directory name if omitted.",
  ...
  discoveryNotes:
    "Scans skill dirs at startup, reads name + description only. Full body loads on invocation. Budget: 2% of context window for all skill descriptions.",
